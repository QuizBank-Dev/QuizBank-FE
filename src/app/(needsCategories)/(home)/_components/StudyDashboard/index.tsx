            ...
            <div className="relative">
                ...
                {!user && (
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                        <div className="flex min-w-[300px] flex-col items-center gap-4 rounded-lg bg-white/80 p-6 shadow-xl">
                            <p className="text-mobile-body-lg drop-shadow-[0_0_8px_#ffffff] md:text-pc-body-lg">
